...
namespace inlib {
    namespace wroot {
        ...
        public:
            ...
            //virtual bool visit(const std::string&,const std::vector<unsigned char>& a_v){
            //  return m_buf.write_array(a_v);
            //}
        ...
        private:
            member_writer(const member_writer& a_from)
                ...
                , m_buf(a_from.m_buf)
            {}
            member_writer& operator=(const member_writer&)
            {
                return *this;
            }
        protected:
