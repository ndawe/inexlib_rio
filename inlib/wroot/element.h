...
namespace inlib {
    namespace wroot {
        ...
        class streamer_element : public virtual ibo {
            ...
            {
                static const std::string s_v("inlib::wroot::streamer_element");
                return s_v;
            }
        public: //ibo
        ...
        public: //streamer_element
            virtual streamer_element* copy() const
            {
                return new streamer_short(*this);
            }
        public:
        ...
        public:
            ...
            {
                streamer_basic_type::operator=(a_from);
                return *this;
            }
        };
        ...
        public: //streamer_element
            virtual streamer_element* copy() const
            {
                return new streamer_float(*this);
            }
        public:
        ...
        public: //streamer_element
            virtual streamer_element* copy() const
            {
                return new streamer_double(*this);
            }
        public:
        ...
        public: //streamer_element
            virtual streamer_element* copy() const
            {
                return new streamer_stat_t(*this);
            }
        public:
