...
namespace inlib {
    namespace rroot {
        ...
        public: //iro
            ...
            {
                if (void* p = cmp_cast< leaf<T> >(this, a_class)) {
                    return p;
                }
        ...
        public:
            static cid id_class()
            {
                return base_leaf_cid() + _cid(T());
            }
            virtual void* cast(cid a_class) const
            {
                if (void* p = cmp_cast<leaf>(this, a_class)) {
                    return p;
                }
        ...
        public: //iro
            virtual void* cast(const std::string& a_class) const
            {
                if (void* p = cmp_cast<leaf_string>(this, a_class)) {
                    return p;
                }
        ...
        public: //iro
            virtual void* cast(const std::string& a_class) const
            {
                if (void* p = cmp_cast<leaf_element>(this, a_class)) {
                    return p;
                }
        ...
        protected:
            ...
            leaf_element& operator=(const leaf_element&)
            {
                return *this;
            }
        public:
