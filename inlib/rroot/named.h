...
namespace inlib {
    namespace rroot {
        ...
        public:
            ...
            {
                if (void* p = cmp_cast<iros>(this, a_class)) {
                    return p;
                } else return 0;
            }
        public:
        ...
        public:
            static cid id_class()
            {
                return ObjArray_cid() + T::id_class();
            }
            virtual void* cast(cid a_class) const
            {
                if (void* p = cmp_cast<ObjArray>(this, a_class)) {
                    return p;
                }
        ...
        public:
            ...
            virtual void* cast(cid a_class) const
            {
                if (void* p = cmp_cast<List>(this, a_class)) {
                    return p;
                } else return 0;
            }
        ...
        public:
            ...
            virtual void* cast(cid a_class) const
            {
                if (void* p = cmp_cast<HashList>(this, a_class)) {
                    return p;
                }
