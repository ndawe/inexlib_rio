...
namespace inlib {
    namespace rroot {
        ...
        public:
            static cid id_class()
            {
                return stl_vector_cid() + _cid(T());
            }
            virtual void* cast(cid a_class) const
            {
                if (void* p = cmp_cast< stl_vector<T> >(this, a_class)) {
                    return p;
                }
        ...
        public:
            static cid id_class()
            {
                return stl_vector_vector_cid() + _cid(T());
            }
            virtual void* cast(cid a_class) const
            {
                if (void* p = cmp_cast< stl_vector_vector<T> >(this, a_class)) {
                    return p;
                }
            ...
            virtual iro* copy() const
            {
                return new stl_vector_vector<T>(*this);
            }
            virtual bool stream(buffer& a_buffer)
            {
        ...
        public:
            static cid id_class()
            {
                return stl_vector_string_cid();
            }
            virtual void* cast(cid a_class) const
            {
                if (void* p = cmp_cast<stl_vector_string>(this, a_class)) {
                    return p;
                }
            ...
            virtual iro* copy() const
            {
                return new stl_vector_string(*this);
            }
            virtual bool stream(buffer& a_buffer)
            {
