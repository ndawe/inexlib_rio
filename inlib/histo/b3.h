...
namespace inlib {
    namespace histo {
        ...
        public:
            ...
            TC Sxyw() const
            {
                return parent::m_in_range_plane_Sxyw[0];
            }
            TC Syzw() const
            {
                return parent::m_in_range_plane_Sxyw[1];
            }
            TC Szxw() const
            {
                return parent::m_in_range_plane_Sxyw[2];
            }
        public:
        ...
        protected:
            bool _find_offset(int aI, int aJ, int aK, TO& a_offset) const
            {
                ...
                if (!parent::m_axes[0].in_range_to_absolute_index(aI, ibin)) {
                    a_offset = 0;
                    return false;
                }

                if (!parent::m_axes[1].in_range_to_absolute_index(aJ, jbin)) {
                    a_offset = 0;
                    return false;
                }

                if (!parent::m_axes[2].in_range_to_absolute_index(aK, kbin)) {
                    a_offset = 0;
                    return false;
                }
