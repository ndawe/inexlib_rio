...
namespace inlib {
    namespace histo {
        ...
        public:
            ...
            {
                return parent::m_dimension;
            }
            dim_t number_of_planes() const
            {
                return dim_planes(parent::m_dimension);
            }
        ...
        public: //histo_data
            ...
            {
                return parent::m_in_range_Sw;   //for CERN-ROOT file writing.
            }
            TW get_in_range_Sw2() const
            {
                return parent::m_in_range_Sw2;   //for CERN-ROOT file writing.
            }
        ...
        public:
            ...
            {
                return parent::m_bin_entries;
            }
            const std::vector<TW>& bins_sum_w() const
            {
                return parent::m_bin_Sw;
            }
            const std::vector<TW>& bins_sum_w2() const
            {
                return parent::m_bin_Sw2;
            }
            const std::vector< std::vector<TC> >& bins_sum_xw() const
            {
                return parent::m_bin_Sxw;
            }
            const std::vector< std::vector<TC> >& bins_sum_x2w() const
            {
                return parent::m_bin_Sx2w;
            }
            const std::vector<TC>& in_range_planes_xyw() const
            {
                return parent::m_in_range_plane_Sxyw;
            }

        public:
            const axis_t& get_axis(int aIndex) const
            {
                return parent::m_axes[aIndex];
            }
            offset_t get_bins() const
            {
                return parent::m_bin_number;
            }
            ...
            bool is_valid() const
            {
                return (parent::m_dimension ? true : false);
            }
        ...
        public: //annotations :
            ...
            bool annotation(const std::string& a_key, std::string& a_value) const
            {
                ...
                if (it == parent::m_annotations.end()) {
                    a_value.clear();
                    return false;
                }
