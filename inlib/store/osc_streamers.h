...
namespace inlib {
    namespace osc {
        ...
        public:
            INLIB_T_SCLASS(T, inlib::osc::Vector)
        protected:
            virtual void* cast(const std::string& a_class) const
            {
        ...
        public:
            INLIB_SCLASS(inlib::osc::Annotation)
        protected:
            virtual void* cast(const std::string& a_class) const
            {
        ...
        public:
            INLIB_T_SCLASS(HIST, inlib::osc::BaseHistogram)
        protected:
            virtual void* cast(const std::string& a_class) const
            {
        ...
        private:
            ...
            {}
            BaseHistogram& operator=(const BaseHistogram&)
            {
                return *this;
            }
        protected:
        ...
        inline bool visitHistogram(const HIST& a_hist, iobj_const_visitor& a_visitor)
        {
            ...
            }
            {
                ...
                if (!a_visitor.visit("fMode", dummy)) return false;
            } //m_mode
        ...
        inline bool readHistogram(hd_data& aData, iobj_visitor& a_visitor)
        {
...

            {
                ...
                if (!a_visitor.visit(dummy)) return false;
            } //m_mode
        ...
        public:
            INLIB_T_SCLASS(HIST, inlib::osc::Histogram)
        protected:
            virtual void* cast(const std::string& a_class) const
            {
        ...
        public:
            INLIB_T_SCLASS(PROF, inlib::osc::Profile)
        protected:
            virtual void* cast(const std::string& a_class) const
            {
